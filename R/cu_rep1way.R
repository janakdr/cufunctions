...
#' @param ddep depvar , groupvar, Subject  (3 required)
#' @param dgp depvar , groupvar, Subject  (3 required)
#' @param dsub depvar , groupvar, Subject  (3 required)
...
#' @param barfill for fill color. Use fill="colors" for colors by group.
...
#' @param pvsize (default NULL) (default 7,3.5)/size of p-values or **
...
#' @param depvar dependent variable (required)
#' @param groupvar grouping factor (required)
