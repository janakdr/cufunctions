...
#' @param depvar required: variable being analyzed, grouping factor
...
#' @param barfill for fill color. Use fill="grey" ="black" etc for single color.
...
#' @param depname to override names of depvar, group1, title
...
#' @param casecontrol =FALSE (default)/TRUE if depvar has 2 levels control and case
