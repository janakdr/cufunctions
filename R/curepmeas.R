...
#' @param dnam required: char-string name of variable being analyzed
...
#' @param g2order =NULL (default)/c("...") to reorder 2nd factor
#' @param difforder =NULL (default)/c("...") to reorder differences
#' @param depname =NULL to override name of depvar
#' @param g1name =NULL to override name of groupvar
#' @param g2name =NULL to override name of fac2
